...
* /includes
  ...
  * /includes/js
	  	* /includes/js/update.js
			...
			* Съдърж функцията setFileLockTimeoutSec(seconds), която след определено време измерно в секунди рефрешва сесията на потребителя, който модифицира файл.
...
* /pages - папка съдържаща страници, към които потребителят бива препратен
	* /pages/upload_no_files_page.html - Страница към която потребителя се препраща, ако не е избрал файлове които да качи, но е клинал на бутона за зареждане на файлове
